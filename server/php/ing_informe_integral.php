...
$ing=$obj->ing_informe_integral($_POST['identificacion'],$_POST['nom_asp'],$_POST['ape_asp'],$_POST['edad'],$_POST['identificacion'],$_POST['estado_civil'],$_POST['cargo'],$_POST['bg3'],
	...
	$_POST['valor_1_4'], $_POST['valor_2_4'],$_POST['valor_3_4'],$_POST['observacion_5'],$_POST['observacion_6'],$_POST['observacion_7'],$fecha,$_POST['prom_total_1'],$_POST['promedio_total_2'],$_POST['prom_total_3'],$_POST['promedio_total_4']);
