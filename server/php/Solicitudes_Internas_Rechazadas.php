...
$datos=$obj-> get_solcitudInternaRechazadas($_SESSION['cod_epl']);
			 ...
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="gh" width="100%" style="color:rgb(41,76,139) !important;">
				...
				<tbody>
						...
						<tr class="remove<?php echo $datos[$i]['id'] ?>"> 
								...
								<td align="center"><a href="ver_req_interna.php?id_req=<?php echo $datos[$i]['id'] ?>&jefe=<?php echo $datos[$i]['cod_epl_jefe'];?>" target="_blank">Ver</a></td>
