		...
		<div class="row-fluid">
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="admin" width="100%" style="color:rgb(41,76,139) !important;">
				<thead style="background-color:rgb(41,76,139) !important;">
					...
					<th style="color:#2b4c88; font-weight: bold" width="9%" scope="col">Fecha prueba</th>
					<th style="color:#2b4c88; font-weight: bold" width="5%" scope="col">Resultados</th>							
			        </tr>
			    </thead>
				<tbody>
						<?php 
...
<script type="text/javascript" charset="utf-8" src="../../js/admin_cmt.js"></script>
