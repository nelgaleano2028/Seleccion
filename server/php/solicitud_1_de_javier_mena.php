...
$datos=$obj-> get_solitudReqCarNuevo_javier_mena();
		...
		<div class="row-fluid">
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="admin" width="100%" style="color:rgb(41,76,139) !important;">
				<thead style="background-color:rgb(41,76,139) !important;">
					...
					<th style="color:#2b4c88; font-weight: bold" width="9%" scope="col">Observaciones Enviadas</th>					
					<th style="color:#2b4c88; font-weight: bold" width="9%" scope="col">Observacion</th>					
			        </tr>
			    </thead>
				<tbody>
						<?php 
						...
						<tr  class="remove<?php echo $datos[$i]['id_form'] ?>"> 
							...
							<td align="center"> <a href="#" onClick="solicitud_mena('<?php echo $datos[$i]['cod_form']; ?>','AC')" >Aceptar</a></td>
							<td align="center"><a href="#" onClick="solicitud_mena('<?php echo $datos[$i]['cod_form']; ?>','RC')" >Rechazar</a></td>
...
<script type="text/javascript" charset="utf-8" src="../../js/solicitud_1_javier_mena.js"></script>
