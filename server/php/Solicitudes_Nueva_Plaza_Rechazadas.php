...
$datos=$obj-> get_solcitudNuevaPlazaRechazadas($_SESSION['cod_epl']);
			 ...
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="gh" width="100%" style="color:rgb(41,76,139) !important;">
				<thead style="background-color:rgb(41,76,139) !important;">
			        <tr>
						...
						<th style="color:#2b4c88; font-weight: bold" width="9%" scope="col">Numero de Personas</th>						
				...
				<tbody>
						...
						<tr class="remove<?php echo $datos[$i]['id_form'] ?>"> 
								...
								<td align="center"><a href="ver_nuevo_cargo2.php?id_form=<?php echo $datos[$i]['id_form']?>&cod_form=<?php echo $datos[$i]['cod_form'] ?>" target="_blank">Ver</a></td>
...
<script type="text/javascript" charset="utf-8" src="../../js/solicitudes_Nuevo_cargo_Rechazadas.js"></script>
