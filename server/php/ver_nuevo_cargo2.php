...
$datos=$obj->get_formRequisicionNuevaPlaza($_GET['id_form'],$_GET['cod_form']);
...
<body  id="main">
				...
				<div class="estirar_form2">
					...
					<div class="cambia">
						...
						<div class="modal-header">
							<h3 id="myModalLabel">Solicitud de Requisicion Nueva Plaza</h3>
						</div>
						<form method="post" id="requisicion_nuevo_cargo" class="active">
							...
							<div class="modal-body2">
								...
								<input type="hidden"  id="llenar1" name="nom_car" value="<?php echo @$datos[0]['nom_car_sol']?>"  />
								<input type="hidden"  id="llenar2" name="personas" value="<?php echo @$datos[0]['num_per_car_sol']?>" />
								...
								<div class="btn-form2" ><input id="EDrequisicion_nuevo_cargoBtn" type="button" class="btn btn-primary" value="Editar"/>&nbsp;&nbsp;&nbsp;&nbsp;
								<input id="requisicion_cancelar" type="button" class="btn btn-primary" value="Cancelar"/></div>
		...
		<div id="mostrar">
			<?php
				...
				include_once('ver_perfil_cargo2.php');
			?>
		</div>
	...
	<script src="../../js/requisicion_nuevo_cargo2.js?js=<?php echo rand(1, 100);?>" type="text/javascript"></script>
</body>
</html>