...
<head>
    ...
    <meta charset="utf-8"/>
	   ...
	   <link rel="stylesheet" href="../../css/bootstrap.min.css?css=46" />
    <link rel="stylesheet" href="../../css/style.css?css=26"  />
    <link rel="stylesheet" href="../../css/font-awesome/css/font-awesome.css?css=20" />
...
<body>
		...
		<div class="estirar_form2">
			...
			<div class="cambia">
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="general">
						<table border="1" style="width: 100%;">
							...
							<tr>
								...
								<td><input type="input"  style="width:200px" name="cmt" value="<?php echo @$datos['cmt']; ?>"  id="cmt" disabled ></td>
				  ...
				  <div class="tab-pane" id="entrevista">
						...
						<div style="float:left; width:100%; margin-top:10px">
							...
							<textarea style=" resize: none; width:800px"  class="observacion_psico" name="observacion_psico" cols="90" rows="9" readonly><?php echo @$datos['observacion_psico']; ?></textarea>		
						</div>
				  ...
				  <div class="tab-pane" id="atencion">
							...
							<div style="float:left; width:50%;">
								...
								<textarea style=" resize: none;  width:400px" name="observacion_1" cols="90" rows="9" readonly><?php echo @$datos['observacion_1']; ?></textarea>							
							</div>
							...
							<div style="float:left; width:50%; padding-top:40px">
								<table border="2">
									...
									<tr>
										...
										<td align="center"><input type="input" style="width:50px" name="valor_1_1" class="10"  maxlength="1" value="<?php echo @$datos['valor_1_1']; ?>" onKeyPress="return validarnum(event)" disabled ></td>
									</tr>
									<tr>
										<td style="font-weight:bold; font-size:12px" align="left">Atencion Selectiva</td>
										<td align="center"><input type="input" style="width:50px" name="valor_2_1" class="20"  maxlength="1" value="<?php echo @$datos['valor_2_1']; ?>" onKeyPress="return validarnum(event)" disabled></td>
									</tr>
									<tr>
										<td style="font-weight:bold; font-size:12px" align="left">Agilidad Procesamiento<br> Informacion</td>
										<td align="center"><input type="input" style="width:50px" name="valor_3_1" class="30"  maxlength="1" value="<?php echo @$datos['valor_3_1']; ?>"  onKeyPress="return validarnum(event)" disabled></td>
									</tr>
									<tr>
										<td style="font-weight:bold; font-size:12px" align="center">Promedio Total</td>
										<td align="center"><input type="input"  style="width:50px" name="prom_total" class="promedio1"  maxlength="1" value="<?php echo @$datos['promedio_1'];?>" disabled></td>
									</tr>
								</table> 
							</div>
				  ...
				  <div class="tab-pane" id="laboral">
						...
						<div style="float:left; width:50%;">
							<span style="font-weight:bold">OBSERVACIONES</span><br><br>
							<textarea style=" resize: none; width:400px"  name="observacion_2" cols="90" rows="9" disabled><?php echo @$datos['observacion_2']; ?></textarea>							
						</div>
						
						<div style="float:left; width:50%; padding-top:40px">
							<table border="2">
								<tr>
									<td style="font-weight:bold; background-color:rgb(201, 201, 201)" align="center" disabled>COMPETENCIAS</td>
									<td style="font-weight:bold; background-color:rgb(201, 201, 201)">PUNTUACION</td>
								</tr>
								<tr>
									<td style="font-weight:bold; font-size:12px" align="left">
									<select name="comp_uno_laboral" disabled> 
									...
									<td align="center"><input type="input" style="width:50px" name="valor_1_2" value="<?php echo @$datos['valor_1_2']; ?>" class="40" value="0" maxlength="1" onKeyPress="return validarnum(event)" disabled></td>
								</tr>
								<tr>
									<td style="font-weight:bold; font-size:12px" align="left">
									<select name="comp_dos_laboral" disabled> 
									...
									<td align="center"><input type="input" style="width:50px" name="valor_2_2" value="<?php echo @$datos['valor_2_2']; ?>" class="50" value="0" maxlength="1" onKeyPress="return validarnum(event)" disabled></td>
								</tr>
								<tr>
									<td style="font-weight:bold; font-size:12px" align="left">
									<select name="comp_tres_laboral" disabled> 
									...
									<td align="center"><input type="input" style="width:50px" name="valor_3_2" class="60" value="<?php echo @$datos['valor_3_2']; ?>"  maxlength="1" onKeyPress="return validarnum(event)" disabled></td>
								</tr>
								<tr>
									<td style="font-weight:bold; font-size:12px" align="center">Promedio Total</td>
									<td align="center"><input type="input" style="width:50px" name="promedio_total_2" class="promedio2" value="<?php echo @$datos['promedio_2']; ?>" maxlength="1" disabled></td>
								</tr>
							</table> 
						</div>
				  ...
				  <div class="tab-pane" id="afectivo">
								...
								<div style="float:left; width:50%;">
									<span style="font-weight:bold">OBSERVACIONES</span><br><br>
									<textarea style=" resize: none;  width:400px" name="observacion_3" cols="90" rows="9" disabled><?php echo @$datos['observacion_3']; ?></textarea>							
								</div>
								...
								<div style="float:left; width:50%; padding-top:40px">
									<table border="2">
										...
										<tr>
											...
											<td align="center"><input type="input" style="width:50px" name="valor_1_3" class="70" disabled value="<?php echo @$datos['valor_1_3']; ?>" maxlength="1" onKeyPress="return validarnum(event)" ></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="left">Restablecimiento</td>
											<td align="center"><input type="input" style="width:50px" name="valor_2_3" class="80" disabled value="<?php echo @$datos['valor_2_3']; ?>" maxlength="1" onKeyPress="return validarnum(event)" ></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="left">Tolerancia al estres</td>
											<td align="center"><input type="input" style="width:50px" name="valor_3_3" class="90" value="<?php echo @$datos['valor_3_3']; ?>" maxlength="1" onKeyPress="return validarnum(event)" disabled></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="center">Promedio Total</td>
											<td align="center"><input type="input" readonly style="width:50px" name="prom_total_3" disabled class="promedio3" value="<?php echo @$datos['promedio_3']; ?>" maxlength="1" ></td>
										</tr>
									</table> 
								</div>
								...
								<div style="float:left; width:50%; padding-top:40px">
									<table border="2">
										...
										<tr>
											...
											<td align="center"><input type="input" style="width:50px" class="100" name="valor_1_4" value="<?php echo @$datos['valor_1_4']; ?>" maxlength="1" onKeyPress="return validarnum(event)" disabled></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="left">Comunicacion</td>
											<td align="center"><input type="input" style="width:50px" class="110" name="valor_2_4" value="<?php echo @$datos['valor_2_4']; ?>" maxlength="1" onKeyPress="return validarnum(event)" disabled></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="left">Trabajo en Equipo</td>
											<td align="center"><input type="input" style="width:50px" class="120"  name="valor_3_4" value="<?php echo @$datos['valor_3_4']; ?>" maxlength="1" onKeyPress="return validarnum(event)" disabled></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="center">Promedio Total</td>
											<td align="center"><input type="input" readonly style="width:50px" class="promedio4" value="<?php echo @$datos['promedio_4']; ?>" name="promedio_total_4"  maxlength="1" disabled></td>
										</tr>
									</table> 
								</div>
				...
				<div class="tab-pane" id="aprendizaje">
					...
					<div style="float:left; width:100%; margin-top:10px">
						<span style="font-weight:bold">OBSERVACION</span><br><br>
						<textarea style=" resize: none; width:800px" name="observacion_5" cols="90" rows="9" disabled><?php echo @$datos['observacion_5']; ?></textarea>		
					</div>
						
					<!--<div style="float:left; width:50%;">
						<span style="font-weight:bold">FORTALEZAS FRENTE AL CARGO</span><br><br>
						<textarea style=" resize: none; width:300px" name="observacion_6" cols="90" rows="9" disabled><?php echo @$datos['observacion_6']; ?></textarea>							
					</div>
					
					<div style="float:left; width:50%;">
						<span style="font-weight:bold">ASPECTOS A MEJORAR FRENTE AL CARGO</span><br><br>
						<textarea style=" resize: none; width:300px" name="observacion_7"  cols="90" rows="9" disabled><?php echo @$datos['observacion_7']; ?></textarea>	
					</div>-->
				...
				<!--Inicio del boton editar
				  ...
				  <input type="hidden" id="idcandidatolab" style="height: 21px;" value="<?php echo $datostable2['id'];?>">
				  
					<h3>Formato de Verificación de las Referencias</h3>
					<div style="float:left; width:100%; margin-top:10px">
						
						Nombre del Canditado:&nbsp;<input type="text" id="nombrecandidato" style="height: 21px;" value="<?php echo $datostable2['nombre_cand'];?>" readonly>
						...
						Fecha:&nbsp;<input type="text" id="fecharlb" value="<?php echo @$datostable2['fecha']; ?>" style="height: 21px;">
					...
					<!--EMPIEZA LA PRIMERA EMPRESA-->
						...
						<div style="float:left; width:100%; margin-top:10px">
							...
							Organización #1:&nbsp;<input type="text" id="organizacion1" style="height: 21px;" value="<?php echo @$datostable2['organizacion_1']; ?> ">
							
							
							Telefono:&nbsp;<input type="text" id="telefono1" style="height: 21px;width: 131px;" value="<?php echo @$datostable2['telefonono_1']; ?> ">
							
							Referido por:&nbsp;<input type="text" id="referido1" style="height: 21px;width: 122px;" value="<?php echo @$datostable2['referido_1']; ?> ">
							
							Cargo:&nbsp;<input type="text" id="cargo1" style="height: 21px;width: 122px;" value="<?php echo @$datostable2['cargo_1']; ?> ">
							...
							Tiempo Laborado:&nbsp;<input type="text" id="tiempol1" style="height: 21px;width: 122px;" value="<?php echo @$datostable2['tiempol_1']; ?> ">
					...
					<!--EMPIEZA LA SEGUNDA EMPRESA-->
						...
						<div style="float:left; width:100%; margin-top:10px">
							...
							Organización #2:&nbsp;<input type="text" id="organizacion2" style="height: 21px;" value="<?php echo @$datostable2['organizacion_2']; ?>">
							
							
							Telefono:&nbsp;<input type="text" id="telefono2" style="height: 21px;width: 131px;" value="<?php echo @$datostable2['telefonono_2']; ?>">
							
							Referido por:&nbsp;<input type="text" id="referido2" style="height: 21px;width: 122px;" value="<?php echo @$datostable2['referido_2']; ?>">
							
							Cargo:&nbsp;<input type="text" id="cargo2" style="height: 21px;width: 122px;" value="<?php echo @$datostable2['cargo_2']; ?>">
							...
							Tiempo Laborado:&nbsp;<input type="text" id="tiempolb2" style="height: 21px;width: 122px;" value="<?php echo @$datostable2['tiempol_2']; ?>">
					...
					<div style="float:left; width:100%; margin-top:10px;  background-color: rgb(213, 213, 213);"><h5><u>Puntajes</u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1: Comp. no presente&nbsp;&nbsp;&nbsp;2: Comp. Nivel mínimo&nbsp;&nbsp;&nbsp;3. Comp. Nivel requerido&nbsp;&nbsp;&nbsp;4. Comp. Nivel superior</h5></div><br /><br /><br />
						...
						<div style="float:left; width:100%; margin-top:10px;">
							...
							Nombre:&nbsp;<input type="text" id="nombrerespersonal" style="height: 21px;" value="<?php echo @$datostable2['nombrepersonal']; ?>">
							
							Telefono:&nbsp;<input type="text" id="telefonorespersonal" style="height: 21px;" value="<?php echo @$datostable2['telefonopersonal']; ?>">
							
							Ocupación:&nbsp;<input type="text" id="ocupacionrespersonal" style="height: 21px;margin-left: 58px;" value="<?php echo @$datostable2['ocupacionper']; ?>">
						...
						<div style="float:left; width:100%; margin-top:10px;">
							...
							Cual?&nbsp;<input type="text" id="descotro" style="height: 21px;  margin-left: 13px;" disabled="disabled" value="<?php echo @$datostable2['cual']; ?>">
							
							Tiempo de Relación:&nbsp;<input type="text" id="tiemporespersonal" style="height: 21px;" value="<?php echo @$datostable2['tiemporeper']; ?>">
						...
						<div style="float:left; width:50%; margin-top:10px;">
						 Verificado por: <input type="text" id="verificadoporultimo" style="height: 21px;" value="<?php echo @$datostable2['verificadoporultimo']; ?>">
						</div>
						
						
						<div style="float:left; width:50%; margin-top:10px;">
						  Concepto gesti&oacute;n humana<input type="text" id="conceptogestionhumana" style="height: 21px;" value="<?php echo @$datostable2['conceptogestionhumana']; ?>">
						</div>
	...
	<script src="../../js/jquery-1.10.1.min.js?js=41" type="text/javascript"></script>
	<script type="text/javascript" src="../../js/jquery-ui.min.js"></script>  
    <script src="../../js/bootstrap.min.js?js=96" type="text/javascript"></script>
