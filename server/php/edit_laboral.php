							...
							<div class="modal-body" style="max-height: 479px !important;">
							 <form id="info_laboral" method="post">
								...
								<div style="float:left; width:50%;">
									...
									<textarea style=" resize: none; width:400px"  name="observacion_2" cols="90" rows="9"><?php echo $datos[0]['observacion_2'] ?></textarea>							
								</div>
								...
								<div style="float:left; width:50%; padding-top:40px">
									<table border="2">
										...
										<tr>
											...
											<td align="center"><input type="input" style="width:50px" name="valor_1_2" class="40" value="<?php echo $datos[0]['valor_1_2'] ?>" maxlength="1" onKeyPress="return validarnum(event)" ></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="left">Integridad</td>
											<td align="center"><input type="input" style="width:50px" name="valor_2_2" class="50" value="<?php echo $datos[0]['valor_2_2'] ?>" maxlength="1" onKeyPress="return validarnum(event)" ></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="left">Orientacion a Resultados</td>
											<td align="center"><input type="input" style="width:50px" name="valor_3_2" class="60" value="<?php echo $datos[0]['valor_3_2'] ?>" maxlength="1" onKeyPress="return validarnum(event)" ></td>
										</tr>
										<tr>
