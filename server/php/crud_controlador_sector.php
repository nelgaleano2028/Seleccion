...
if($flag==1){
	//ELIMINAR
	  ...
	  $resultado=$obj->eliminar_datos_sector($id);
	...
	//ACTUALIZAR
	  ...
	  $resultado=$obj->actualizar_datos_sector($column, $value, $id);
	  ...
	  if($resultado===1){
		...
		$nom_sector=$_REQUEST['nom_sector'];
		
       
				
		$resultado=$obj->insertar_datos_sector($nom_sector);
