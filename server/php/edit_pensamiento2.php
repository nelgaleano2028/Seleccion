							...
							<div class="modal-body" style="max-height: 479px !important;">
							 <form id="info_pensamiento" method="post">
								...
								<div style="float:left; width:100%; margin-top:10px">
									...
									<textarea style=" resize: none; width:800px" name="observacion_4" cols="90" rows="9" readonly><?php echo $datos[0]['observacion_4'] ?></textarea>		
								</div>
								...
								<div style="float:left; width:50%;">
									...
									<textarea style=" resize: none; width:300px" name="observacion_5" cols="90" rows="9" readonly><?php echo $datos[0]['observacion_5'] ?></textarea>							
								</div>
								
								<div style="float:left; width:50%;">
									<span style="font-weight:bold">ASPECTOS A MEJORAR FRENTE AL CARGO</span><br><br>
									<textarea style=" resize: none; width:300px" name="observacion_6"  cols="90" rows="9" readonly><?php echo $datos[0]['observacion_6'] ?></textarea>	
								</div>
