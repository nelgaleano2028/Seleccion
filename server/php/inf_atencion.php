							 ...
							 <form id="info_atencion" method="post">
								...
								<div style="float:left; width:50%; padding-top:40px">
									<table border="2">
										...
										<tr>
											...
											<td align="center"><input type="input" readonly style="width:50px" name="prom_total" class="promedio" value="0" maxlength="1" ></td>
										</tr>
									</table> 
								</div>
								...
								<div style="float:left; width:100%; margin-top:30px">
								  ...
								  <div style="float:left; width:100%; margin-top:50px">
								  		<input type="button" class="btn btn-primary ant_obsrvaciones"  value="Anterior"/>&nbsp;
								  		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								  		<input type="button" class="btn btn-primary enviar_atencion"   value="Siguiente"/>
								  </div>
