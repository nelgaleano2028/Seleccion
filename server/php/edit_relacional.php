							...
							<div class="modal-body" style="max-height: 479px !important;">
							 <form id="info_relacional" method="post">
								...
								<div style="float:left; width:50%;">
									...
									<textarea style=" resize: none; width:400px" name="observacion_3" cols="90" rows="9"><?php echo $datos[0]['observacion_3'] ?></textarea>							
								</div>
								...
								<div style="float:left; width:50%; padding-top:40px">
									<table border="2">
										...
										<tr>
											...
											<td align="center"><input type="input" style="width:50px" class="70" name="valor_1_3" value="<?php echo $datos[0]['valor_1_3'] ?>" maxlength="1" onKeyPress="return validarnum(event)" ></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="left">Comunicacion</td>
											<td align="center"><input type="input" style="width:50px" class="80" name="valor_2_3" value="<?php echo $datos[0]['valor_2_3'] ?>" maxlength="1" onKeyPress="return validarnum(event)" ></td>
										</tr>
										<tr>
											<td style="font-weight:bold; font-size:12px" align="left">Trabajo en Equipo</td>
											<td align="center"><input type="input" style="width:50px" class="90"  name="valor_3_3" value="<?php echo $datos[0]['valor_3_3'] ?>" maxlength="1" onKeyPress="return validarnum(event)" ></td>
										</tr>
										<tr>
