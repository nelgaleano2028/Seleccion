...
$datos=$obj-> get_solitudReqCarNuevoConfirmadas_plaza();
		...
		<div class="row-fluid">
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="admin" width="100%" style="color:rgb(41,76,139) !important;">
				<thead style="background-color:rgb(41,76,139) !important;">
					...
					<td style="color:#2b4c88; font-weight: bold" width="5%" scope="col">Aceptar</td>
				...
				<tbody>
						...
						<tr  class="remove<?php echo $datos[$i]['id_form'] ?>"> 
							...
							<td align="center"> <a href="#" onClick="solicitud_javier_co('<?php echo $datos[$i]['cod_form']; ?>','AEX')" >Aceptar</a></td>
...
<script type="text/javascript" charset="utf-8" src="../../js/solicitud_1_javier_co.js"></script>
