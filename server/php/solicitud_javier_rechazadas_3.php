...
$datos=$obj-> get_solitudReqNuevaPlaza_Rechazadas();
			 ...
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="admin" width="100%" style="color:rgb(41,76,139) !important;">
				...
				<tbody>
						...
						<tr  class="remove<?php echo $datos[$i]['id_form'] ?>"> 
							...
							<td align="center"><a href="ver_nuevo_cargo.php?id_form=<?php echo $datos[$i]['id_form']?>&cod_form=<?php echo $datos[$i]['cod_form'] ?>" target="_blank">Ver</a></td>
                        </tr>
