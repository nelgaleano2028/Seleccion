...
$datos=$obj->ing_requisicion_nuevo_cargo($cod_form,$centro_costo,$cargoRequerido,$motivo,$fec1,$fec2,$fec3,$fec4,$personsa_sugerida,$cod_epl_jefe,$fecha_solicitud,$_POST['nom_car_nuevo'],$_POST['ubicacion2']);
