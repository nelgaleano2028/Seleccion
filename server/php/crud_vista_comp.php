...
$datos=$obj-> consultar_datos_comp();
?>
<html>
<head>
			 ...
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="example" width="100%" style="color:rgb(41,76,139) !important;">
				...
				<thead style="background-color:rgb(41,76,139) !important;">
			        <tr>
						...
						<th style="color:white; font-weight: bold" width="8%" scope="col">NOMBRE COMPETENCIA</th>
				...
				<tbody>
						...
						<tr id='<?php echo $datos[$i]['id']; ?>'> 
							...
							<td align="center"><?php echo $datos[$i]['nombre_comp']; ?></td>
...
<!-- Custom form for adding new records -->
 <form id="formAddNewRow" action="#" title="Adicionar Registro">
        ...
        <label for="platforms">Nombre Competencia</label>
		<br />
		<input type="text" name="nombre_comp" id="nombre_comp" class="required" rel="0" />
		...
		<script type="text/javascript" charset="utf-8" src="../../js/script_datatable_comp.js"></script>
