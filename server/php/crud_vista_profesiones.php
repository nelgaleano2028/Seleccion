...
$datos=$obj-> consultar_datos_prof();
?>
<html>
<head>
			 ...
			 <table cellpadding="0" cellspacing="0" border="0" class="display " id="example" width="100%" style="color:rgb(41,76,139) !important;">
				...
				<thead style="background-color:rgb(41,76,139) !important;">
			        <tr>
						...
						<th style="color:white; font-weight: bold" width="8%" scope="col">NOMBRE PROFESION</th>
				...
				<tbody>
						...
						<tr id='<?php echo $datos[$i]['id']; ?>'> 
							...
							<td align="center"><?php echo $datos[$i]['nom_profe']; ?></td>								
...
<!-- Custom form for adding new records -->
 <form id="formAddNewRow" action="#" title="Adicionar Registro">
        <label for="engine">Nombre Profesion</label>
		<br />
		<input type="text" name="nom_profe" id="nom_profe" class="required" rel="0" />
		...
		<script type="text/javascript" charset="utf-8" src="../../js/script_datatable_prof.js"></script>
