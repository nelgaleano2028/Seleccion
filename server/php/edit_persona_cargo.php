...
$edit_desc_cargo_nuevo=$obj_desc_cargo_nuevo->edit_desc_cargo_nuevo($cod_epl,$_POST['nomCar'],$_POST['ubicacion'],$_POST['gerencia'],$_POST['coordinacion'],$_POST['cargo_hace'],$_POST['cargo_como'],$_POST['cargo_para'],$cod_resp,$cod_rel,$_POST['numero_pacientes1'],
					   ...
					   $_POST['presupuesto_area1'],$_POST['presupuesto_area2'],$_POST['cumplir_meta8'],$_POST['actividades_no'],$_POST['Impacto_esperado2'],$fecha,$observaciones,$id_habilidad_actitud,$_POST['id_form']);
