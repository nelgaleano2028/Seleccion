      ...
      <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
							 ...
							 <li><a tabindex="-1"   id="inicial" href="#agregar_tiempo" class="text">MODIFICAR TIEMPOS PRUEBAS</a></li>
                ...
                <a class="brand" href="#"><span id="titulo" class="first"><?php echo $_SESSION['nom'] ?></span></a>
            </div>
        </div>
    </div>
    <div id="content"></div>
