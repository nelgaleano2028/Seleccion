...
if($datos2[0]['motivo_ausencia'] != ""){

$obj8= new Utilidades();

$fecha_dias=$obj8->formatFecha($datos2[0]['fec_sol']);



$obj7=  new Requisicion();


$dias= $obj7->get_dias( $fecha_dias, $datos2[0]['reemp'], $datos2[0]['motivo_ausencia']);
		...
		<div class="estirar_form2">
			...
			<div class="cambia" style="height: 600px;">
				...
				<div class="modal-body3" style="max-height: 470px !important">
						...
						<select name="centro_costo" class="centro_costo">
							...
							<?php
								for($i=0; $i<count($datos); $i++){
									...
									if($datos2[0]['cod_cc2'] != $datos[$i]['codigo']){
					...
					<div class="btn-form2" ><input id="EDrequisicion_internaBtn" type="button" class="btn btn-primary" value="Editar"/>
				</div>
				</form>
				<!--inicio modal-body3-->
			</div>
