					 ...
					 <table cellpadding="0" cellspacing="0" border="0" class="display " id="gh" width="100%" style="color:rgb(41,76,139) !important;">
						...
						<tbody>
								...
								<tr> 
										...
										<td align="center"><select   onchange="cambiar_estado('<?php echo $datos[$i]['codigo']; ?>','<?php echo $datos[$i]['cod_form']; ?>')" ><option value="<?php echo $datos[$i]['estado'];?>"><?php echo $estado_vacante;?></option><option value="Cerrado">Cerrado</option></select></td>
...
<script type="text/javascript" charset="utf-8" src="../../js/vacantes_avila.js"></script>
