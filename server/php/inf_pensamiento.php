	          	...
	          	<center>
						<div class="cambia" style="height:550px; width:850px">
							...
							<div class="modal-body" style="max-height: 479px !important;">
							 <form id="informacion_pensamiento" method="post">
								...
								<div style="float:left; width:50%;">
									...
									<textarea style=" resize: none; width:300px" name="observacion_6" cols="90" rows="9"></textarea>							
								</div>
								
								<div style="float:left; width:50%;">
									<span style="font-weight:bold">ASPECTOS A MEJORAR FRENTE AL CARGO</span><br><br>
									<textarea style=" resize: none; width:300px" name="observacion_7"  cols="90" rows="9"></textarea>	
								</div>
								...
								<div style="float:left; width:100%; margin-top:30px">
									<table border="1" style="width: 80%;">
							 		...
							 		<input type="hidden" class="promedio banderase" name="promedio_total" value="<?php 



							 			$promedio_final=($_GET['promedio']/3);
