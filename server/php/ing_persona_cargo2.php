...
$ing_desc_cargo_nuevo=$obj_desc_cargo_nuevo->insert_desc_cargo_nuevoDos($cod_epl,$_POST['nomCar'],$_POST['ubicacion'],$_POST['gerencia'],$_POST['coordinacion'],$_POST['cargo_hace'],$_POST['cargo_como'],$_POST['cargo_para'],$cod_resp,$_POST['numero_pacientes1'],
					   ...
					   $_POST['presupuesto_area1'],$_POST['presupuesto_area2'],$_POST['cumplir_meta8'],$_POST['actividades_no'],$_POST['Impacto_esperado2'],$fecha,$observaciones,$id_habilidad_actitud,$_POST['nom_car_sol'],$_POST['num_per_car_sol'],$_POST['desc_car_sol']);
