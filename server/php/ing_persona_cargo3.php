...
$ing_desc_cargo_nuevo=$obj_desc_cargo_nuevo->insert_desc_cargo_nuevoTres($_POST['numero_pacientes1'],
					   ...
					   $_POST['presupuesto_area1'],$_POST['presupuesto_area2'],$_POST['cumplir_meta8'],$_POST['actividades_no'],$_POST['Impacto_esperado2'],$fecha,$observaciones,$_POST['nom_car_sol'],$_POST['num_per_car_sol'],$_POST['desc_car_sol']);
