var Alert={
	...
	alert: function (mensaje,callback){
	 ...
	 var contenido='<div id="mensaje">';
		 ...
		 contenido+='<a href="javascript:void(0);" style="color:#fff;"  id="aceptar" class="btn btn-primary">Aceptar</a>';
		 contenido+='</div>'
	     contenido+='</div>';
	...
	close: function (mensaje,callback){
	...
	confirmacion: function (mensaje, callback1, callback2){
		
		var contenido='<div id="mensaje">';
	     contenido+=''+mensaje+'';
		 contenido+='<div class="botones" style="text-align:center;">';
		 contenido+='<a href="javascript:void(0);" style="color:#fff;"  id="aceptar" class="btn btn-primary">Aceptar</a>&nbsp;&nbsp;&nbsp;';
		 contenido+='<a href="javascript:void(0);" style="color:#fff;"  id="cancelar" class="btn btn-primary">Cancelar</a>';
		 contenido+='</div>'
	     contenido+='</div>';
	 
		 this.modalVer("Informaci&oacute;n  <i class='icon-exclamation-sign'></i>",contenido);
	...
	modalVer: function(titulo,mensaje){
		
		 var modal='<!-- Modal -->';
			modal+='<div id="myModal6" class="modal hide fade" style="margin-top: 10%; background-color: rgb(41, 76, 139); color: #fff; z-index: 999999; behavior: url(../../css/PIE.htc);width: 30%; left:55%;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="true">';
	...
	modals3:function (titulo,mensaje){
	       var modal='<!-- Modal -->';
			modal+='<div id="myModal6" class="modal hide fade" style="margin-top: 10%; background-color: rgb(41, 76, 139); color: #fff; z-index: 900001; behavior: url(../../css/PIE.htc);width: 30%; left:55%;" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="true">';
			modal+='<div class="modal-header" style="border-bottom: 0px !important;">';
			modal+='<button type="button" class="close" style="color:#fff !important;" data-dismiss="modal" aria-hidden="true">x</button>';
			modal+='<h4 id="myModalLabel">'+titulo+'</h4>';
			modal+='</div>';
