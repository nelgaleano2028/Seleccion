	...
	if($('#requisicion_nuevo_cargo').valid()){
		...
		if($('#llenar').val() == ""){
			...
			$.ajax({
				...
				url:'ing_requisicion_nuevo_cargo.php',
				type:'POST',
	...
	if($('#requisicion_nuevo_cargo').valid()){
		...
		if($('#llenar').val() == ""){
			...
			$.ajax({
				...
				url:'ed_requisicion_nuevo_cargo.php',
				type:'POST',
				data:$('#requisicion_nuevo_cargo').serialize(),
				dataType:'html',
				success:function(data){
					...
					/*alert personalizado*/
					Alert.close(mensaje,function(){$('#myModal6').modal('hide');});
