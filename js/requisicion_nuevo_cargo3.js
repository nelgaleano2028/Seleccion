...
function ing_persona_cargo(){
	...
	if ($('#personas_cargoFrm').valid()) {
		...
		var datos = $('input[name^="funcion"], input[name^="porcentaje"], textarea[name^="funcion1"], textarea[name^="funcion2"], textarea[name^="funcion3"], input[name^="area"], input[name^="cliente"], input[name^="proveedor"], input[name^="habilidades"]').serializeArray();
			
		datos.push({name:'nomCar', value:$("input[name=nomCar]").val()}, {name:'ubicacion', value:$("input[name=ubicacion]").val()}, {name:'gerencia', value:$("input[name=gerencia]").val()}, {name:'coordinacion', value:$("input[name=coordinacion]").val()},
		{name:'cargo_hace', value:$("textarea[name=cargo_hace]").val()}, {name:'cargo_como', value:$("textarea[name=cargo_como]").val()}, {name:'cargo_para', value:$("textarea[name=cargo_para]").val()}, {name:'numero_pacientes1', value:$("input[name=numero_pacientes1]").val()},
		...
		$.ajax({
			...
			success:function(data){
				...
				$("#llenar").val(data);
				$("#llenar1").val($("input[name=nomCar]").val());
				$("#llenar2").val($("input[name=ubicacion]").val());
			}
		});
...
function edit_persona_cargo(){
	...
	if ($('#personas_cargoFrm').valid()) {
		...
		datos.push({name:'nomCar', value:$("input[name=nomCar]").val()}, {name:'ubicacion', value:$("#personas_cargoFrm input[name=ubicacion]").val()}, {name:'gerencia', value:$("input[name=gerencia]").val()}, {name:'coordinacion', value:$("input[name=coordinacion]").val()},
		{name:'cargo_hace', value:$("textarea[name=cargo_hace]").val()}, {name:'cargo_como', value:$("textarea[name=cargo_como]").val()}, {name:'cargo_para', value:$("textarea[name=cargo_para]").val()}, {name:'numero_pacientes1', value:$("input[name=numero_pacientes1]").val()},
		{name:'numero_pacientes2', value:$("input[name=numero_pacientes2]").val()},{name:'cumplir_meta1', value:$("input[name=cumplir_meta1]").val()},{name:'numero_ventas1', value:$("input[name=numero_ventas1]").val()},{name:'numero_ventas2', value:$("input[name=numero_ventas2]").val()},{name:'cumplir_meta2', value:$("input[name=cumplir_meta2]").val()},
		{name:'numero_procedimientos1', value:$("input[name=numero_procedimientos1]").val()},{name:'numero_procedimientos2', value:$("input[name=numero_procedimientos2]").val()}, {name:'cumplir_meta3', value:$("input[name=cumplir_meta3]").val()},
		{name:'utilidad_neta1', value:$("input[name=utilidad_neta1]").val()},{name:'utilidad_neta2', value:$("input[name=utilidad_neta2]").val()}, {name:'cumplir_meta4', value:$("input[name=cumplir_meta4]").val()},
		...
		{name:'gastos_administrativos1', value:$("input[name=gastos_administrativos1]").val()}, {name:'gastos_administrativos2', value:$("input[name=gastos_administrativos2]").val()},{name:'cumplir_meta7', value:$("input[name=cumplir_meta7]").val()},
		{name:'presupuesto_area1', value:$("input[name=presupuesto_area1]").val()}, {name:'presupuesto_area2', value:$("input[name=presupuesto_area2]").val()},{name:'cumplir_meta8', value:$("input[name=cumplir_meta8]").val()},
		{name:'actividades_no', value:$("textarea[name=actividades_no]").val()}, {name:'Impacto_esperado2', value:$("textarea[name=Impacto_esperado2]").val()}, {name:'cod_jefe', value:$("input[name=cod_jefe]").val()},{name:'cod_resp',value:$("input[name=cod_resp]").val()}, {name:'cod_rel',value:$("input[name=cod_rel]").val()},{name:'id_form',value:$("input[name=id_form]").val()},
		{name:'nom_car_sol', value:$("input[name=nom_car_sol]").val()}, {name:'num_per_car_sol', value:$("input[name=num_per_car_sol]").val()}, {name:'desc_car_sol', value:$("textarea[name=desc_car_sol]").val()});
		
		$.ajax({
		
			url:'edit_persona_cargo3.php',
			type:'POST',
			data:datos,
			dataType:'html',
			success:function(data){
				...
				if(data == 1){
					...
					$("#llenar1").val($("input[name=nomCar]").val());
				    $("#llenar2").val($("#personas_cargoFrm input[name=ubicacion]").val());
...
function requisicion_nuevo_cargo(){
	...
	if($('#requisicion_nuevo_cargo').valid()){
		...
		if($('#llenar').val() == ""){
			...
			$.ajax({
				...
				url:'ing_requisicion_nuevo_cargo2.php',
				type:'POST',
	...
	if($('#requisicion_nuevo_cargo').valid()){
		...
		if($('#llenar').val() == ""){
			...
			$.ajax({
				...
				url:'ed_requisicion_nuevo_cargo2.php',
				type:'POST',
				data:$('#requisicion_nuevo_cargo').serialize(),
				dataType:'html',
				success:function(data){
