	...
	$.ajax({
		...
		success:function(res){
			...
			if(res != false){
			 ...
			 $('#contenido8').load('edit_pensamiento.php?id='+$("#id").val()+'&promedio='+promedio);
	...
	$.ajax({
		...
		success:function(res){
			...
			if(res != false){
			 ...
			 $('#contenido6').load('edit_relacional.php?id='+$("#id").val()+'&promedio='+promedio);
	...
	$.ajax({
		...
		success:function(res){
			...
			if(res != false){
			 ...
			 $('#contenido4').load('edit_laboral.php?id='+res+'&promedio='+promedio);
...
function informe(cedula){
	...
	$('#contenido2').load('edit_atencion.php?cedula='+cedula);
