				...
				$.ajax({url: "../../server/php/cambiapass.php",
						...
						success:function(data){
							...
							if(acceso=='1'){
								...
								return false;
							}else if(acceso=='SELECCIONJEF'){
								modals("Notificacion","Se Ingresaron los Datos Correctamente","main_jefe.php");							
								return false;
							}else if(acceso=='SELECCIONCO'){
								modals("Notificacion","Se Ingresaron los Datos Correctamente","main_coor.php");								
								return false;
							}else if(acceso=='SELECCIONHE'){
								modals("Notificacion","Se Ingresaron los Datos Correctamente","main_sico.php");								
								
								return false;
							}else if(acceso=='SELECCIONGE'){
								modals("Notificacion","Se Ingresaron los Datos Correctamente","main_gerencia.php");								
								
								return false;
							}else if(acceso=='SELECCION'){
								modals("Notificacion","Se Ingresaron los Datos Correctamente","main_gh.php");								
