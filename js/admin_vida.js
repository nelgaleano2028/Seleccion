...
function main(){
	 ...
	 $('#example thead#cabeza td').each( function () {
        var title = $('#example thead td').eq( $(this).index() ).not('.noSearch').text();

        $(this).not('.noSearch').html( '<input  style="width: 150px;" type="text" placeholder="'+title+'" />' );
    } );
...
function enviarPruebas(cedula){

	
	if($("#vacante").val()==""){

		var mensaje="<p style='text-align:center; color:green; font-weight:bold;'>Debe seleccionar una vacante</p>";
		...
		$.ajax({
		   url: "verificar_prueba_asp.php",
		   type:"POST",
		   data: "cedula="+cedula+"&bandera="+1,
		   success: function (res){
		   		...
		   		if(res != 1){
		   			...
		   			var mensaje="<p style='text-align:center; color:blue; font-weight:bold;'>"+res+"</p>";
							   	...
							   	if(res!= 1){
									...
									function(){
										$.ajax({
										   ...
										   url: "enviar_prueba_asp.php",
										   type:"POST",
										   data: "cedula="+cedula+"&vacante="+$("#vacante").val(),
										   success: function (res){
									   ...
									   success: function (res){
									   		...
									   		if(res==1){
									   			...
									   			var mensaje="<p style='text-align:center; color:green; font-weight:bold;'>El Aspirante se ha enviado correctamente</p>";

									   		}else{


									   				var mensaje="<p style='text-align:center; color:green; font-weight:bold;'>Intentalo de nuevo...</p>";
	   ...
	   success: function (res){
	   		...
	   		if(res==-1){
				...
				var html="<div id='esconder_pruebas'>";
		   			html+="<div id='contenedor'><center><table style='color:black; width: 300px;' border=1>";
		   		    html+="<tr>";
